...
import { SuccessAuthResponse } from 'src/modules/auth/interfaces/auth-response.interface'
...
import { User, UserSchemaModel } from 'src/modules/users/schemas/user.schema'
